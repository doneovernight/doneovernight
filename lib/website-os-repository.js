...
const MODULE_TABLES = Object.freeze({
  ...
  businessProfile: "website_os_business_profiles",
  domain: "website_os_domains",
  emailIdentity: "website_os_email_identities",
  document: "website_os_documents",
  documentVersion: "website_os_document_versions",
  documentWorkflow: "website_os_document_workflows",
  policy: "website_os_policies",
  policyAcceptance: "website_os_policy_acceptances",
  invoiceDocument: "website_os_invoice_documents"
});
...
const ACTOR_FIELDS = Object.freeze({
  ...
  businessProfile: "created_by",
  domain: "created_by",
  emailIdentity: "created_by",
  document: "created_by",
  documentVersion: "published_by",
  documentWorkflow: "created_by",
  policy: "created_by",
  invoiceDocument: "attached_by"
});
...
const AUDIT_FIELDS = [
  ...
  "document_type", "version_number", "version_label", "document_id", "document_version_id",
  "policy_key", "requirement", "visibility", "destination", "revision", "enabled",
