...
function buildPaymentConfirmationEmail(task = {}, workspace = {}, invoiceResult = {}) {
  ...
  const copy = language === "nl"
    ? {
        subject: "DONEOVERNIGHT — Betaling ontvangen",
        preheader: `Betaling ontvangen. Factuur ${invoice.invoice_number || ""}`,
        statusLabel: "BETALING ONTVANGEN",
        title: "Betaling ontvangen.",
        intro: "Je betaling is bevestigd.",
        lead: "Je workspace is actief en je project staat klaar voor uitvoering. De factuur is als PDF toegevoegd.",
        bullets: ["Betaling bevestigd", "Workspace actief", "Project actief", "Factuur toegevoegd"],
        taskLabel: "DON-referentie",
        statusCard: "Status",
        statusValue: "Project actief",
        nextStepCard: "Factuur",
        nextStepValue: invoice.invoice_number || "Bijgevoegd",
    ...
    : {
        ...
        preheader: `Payment confirmed. Invoice ${invoice.invoice_number || ""}`,
        statusLabel: "PAYMENT CONFIRMED",
        title: "Payment confirmed.",
        intro: "We received your payment.",
        lead: "Your workspace is active and your project is ready for execution. The invoice is attached as a PDF.",
        bullets: ["Payment confirmed", "Workspace active", "Project active", "Invoice attached"],
        taskLabel: "DON Reference",
        statusCard: "Status",
        statusValue: "Project active",
        nextStepCard: "Invoice",
        nextStepValue: invoice.invoice_number || "Attached",
...
async function sendPaymentConfirmationEmailViaResend(task, workspace, invoiceResult, options = {}) {
  ...
  if (!config.configured) {
    return {
      ...
      provider: "none",
      missing: [
        "PAYMENT_CONFIRMATION_EMAIL_WEBHOOK_URL or PAYMENT_RECEIPT_EMAIL_WEBHOOK_URL or CLIENT_PAYMENT_EMAIL_WEBHOOK_URL",
        ...config.missing
      ]
    };
  }
