...
function buildNeedsInfoEmail(task = {}) {
  ...
  const email = buildClientEmail({
    ...
    infoCards: [
      ["Status", "Needs Info"],
      ["Next Step", "Secure Review"]
    ],
    body: [
      infoRequest ? `Needed: ${infoRequest}` : "",
      "Open the secure review page to provide the information and keep everything tied to this DON reference."
    ],
    ctaLabel: reviewUrl ? "Provide information" : "",
    ctaUrl: reviewUrl,
