...
function buildNeedsInfoEmail(task = {}) {
  ...
  const email = buildClientEmail({
    ...
    intro: `Hi ${name}, your request has been reviewed. One detail is needed before DONEOVERNIGHT can prepare the execution plan.`,
    rows: [
      ["Reference", reference],
      infoRequest ? ["Needed", infoRequest] : null
    ],
