...
module.exports = { CHECKPOINTS, OBJECTIVES, PAUSE_KEY, SAFE_STOP_KEY, SCHEDULE_STATUSES, activateLearningVersion, audit, auditMode, cadenceBlocks, collectMetricCheckpoints, evaluateDraft, forceHumanReview, nextSlot, objectiveFor, parseWindows, processScheduled, requiredAudit, runAutonomyCycle, runLearningCycle, setPause, cancelSchedule, revertLearningVersion, strategicMixPenalty, scheduleGraceMs };
