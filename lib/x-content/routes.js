...
async function commandCenterSnapshot() {
  ...
  return { drafts, publications, published_posts: publishedPosts, analytics, interactions, reply_drafts: replyDrafts, sources, source_controls: sourceControls, runs, autonomy: autonomyState, daily_plan: dailyPlan, heartbeat, account_activity: accountActivity || heartbeat?.accountActivity || null, x_account: xAccount, radar: radarItems, growth: { strategies: growthStrategies, decisions: growthDecisions }, system };
}
