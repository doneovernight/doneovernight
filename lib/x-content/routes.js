...
async function commandCenterSnapshot() {
  ...
  return { drafts, publications, analytics, interactions, reply_drafts: replyDrafts, sources, source_controls: sourceControls, runs, autonomy: autonomyState, heartbeat, radar: radarItems, growth: { strategies: growthStrategies, decisions: growthDecisions }, system };
}
