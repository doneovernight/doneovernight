...
async function commandCenterSnapshot() {
  ...
  return { drafts, publications, analytics, interactions, reply_drafts: replyDrafts, sources, source_controls: sourceControls, runs, autonomy: autonomyState, heartbeat, account_activity: accountActivity || heartbeat?.accountActivity || null, radar: radarItems, growth: { strategies: growthStrategies, decisions: growthDecisions }, system };
}
