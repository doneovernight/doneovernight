...
async function commandCenterSnapshot() {
  ...
  return { drafts, publications, analytics, interactions, reply_drafts: replyDrafts, sources, source_controls: sourceControls, runs, autonomy: autonomyState, heartbeat, system };
}
...
module.exports = { discover, publish, heartbeat, engagement, regenerateLegacy, autonomyDecision, autonomyPublish, autonomyMetrics, identity, oauthStart, oauthCallback, admin };
