...
async function heartbeat() {
  ...
  const [discovery, publishing, autonomyPublishing, failedAutonomyPublishing, autonomyRuns, drafts, publications, activityRows, activitySetting, safeStopSetting, schedules] = await Promise.all([
