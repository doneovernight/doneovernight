...
async function heartbeat() {
  ...
  const publishingHealthy = autonomousMode ? autonomyPublishing?.status === "completed" : autonomyPublishing ? autonomyPublishing.status === "completed" : publishing ? publishing.status === "completed" : null;
