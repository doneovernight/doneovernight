...
async function heartbeat() {
  ...
  const [discovery, publishing, autonomyPublishing, drafts, publications, activityRows, activitySetting] = await Promise.all([
    repository.latestRun("discovery"), repository.latestRun("publishing"), repository.latestRun("autonomy_publish"), repository.recentDrafts(), repository.publicationsToday(),
