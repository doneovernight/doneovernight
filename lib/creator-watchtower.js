...
async function reportCreatorError(input = {}) {
  ...
  const alert = {
    ...
    watchtower_version: safeText(input.watchtower_version || input.watchtowerVersion || "", 80),
  ...
  if (isSuppressedAdminAuthNoise(alert)) {
    ...
    return { success: true, alert_sent: false, suppressed: true, reason: "admin_creator_settings_401_auth_noise", fingerprint: alert.fingerprint };
  }
